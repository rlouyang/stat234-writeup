...
Finally, the obvious next step would be to test the convolutional models using different network configurations and the suggested parameters to see if PCA continues to provide improvements. We expect that convolutions ought to do better since they capture structural information, and furthermore do better 
