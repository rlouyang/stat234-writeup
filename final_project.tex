...
\begin{figure*}
    \centering
    \includegraphics{}
    \caption{An example plot of the average optimal Q-value over 128 randomly chosen states. This particular graph is for our best model, a DDQN-PCA with two hidden layers of sizes 128 and 64.}
    \label{fig:sample_Q}
\end{figure*}
