...
\usepackage[utf8]{inputenc} % \doublespacing

\title{State Space Reduction in Deep Q Networks} \author{Michael Ge,
Richard Ouyang} \date{April 24, 2018}
...
methods used in recent papers \todo{CITE} require often infeasible
...
{ \subfloat[Sample original image of the \game~game
screen. \label{subfig:\game_original}]{%
\includegraphics[width=0.35\textwidth]{final_project/game_images/\game_original.pdf}
} \hfill \subfloat[Sample processed image of the \game~game
screen.\label{subfig:\game_processed}]{%
...
structured data\todo{explain why}.
...
learning rate) \todo{add more hyperparameters}
...
\begin{figure*}[!ht] \foreach \game in {CartPole, Acrobot, MountainCar}
{ \subfloat[Rewards for a random policy in the
\game~game. \label{subfig:\game_NoTraining_Random_rewards}]{%
\includegraphics[width=0.45\textwidth]{final_project/\game/\game_NoTraining_Random_rewards.pdf}
} \hfill \subfloat[Durations for a random policy in the
\game~game.\label{subfig:\game_NoTraining_Random_durations}]{%
...
\begin{figure*}[!ht] \foreach \game in {CartPole, Acrobot, MountainCar}
{ \subfloat[Rewards for a DQN policy in the \game~game with
$\texttt{lr}=0.001$, RMSProp optimizer, Huber
Loss. \label{subfig:\game_DQN_GS_EpsilonGreedy_rewards}]{%
\includegraphics[width=0.45\textwidth]{final_project/\game/\game_DQN_GS_EpsilonGreedy_rewards.pdf}
} \hfill \subfloat[Durations for a DQN policy in the \game~game with
$\texttt{lr}=0.001$, RMSProp optimizer, Huber
Loss. \label{subfig:\game_DQN_GS_EpsilonGreedy_durations}]{%
\includegraphics[width=0.45\textwidth]{final_project/\game/\game_DQN_GS_EpsilonGreedy_rewards.pdf}
} }
...
\begin{figure*}[!ht] \foreach \game in {CartPole, Acrobot, MountainCar}
{ \subfloat[Sample original image of the \game~game
screen. \label{subfig:\game_DQCNN_PCA}]{%
\includegraphics[width=0.35\textwidth]{final_project/game_images/\game_DQCNN_PCA.pdf}
} \hfill \subfloat[Sample processed image of the \game~game
screen.\label{subfig:\game_DQCNN_PCA_Mini}]{%
\includegraphics[width=0.35\textwidth]{final_project/game_images/\game_DQCNN_PCA_Mini.pdf}
} }
...
\newpage \bibliography{final_project}{} \bibliographystyle{plain}
